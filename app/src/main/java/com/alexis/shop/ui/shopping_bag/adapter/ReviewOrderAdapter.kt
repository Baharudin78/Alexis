...
/**
 * Created by Uwais Alqadri on July 21, 2021
 */
class ReviewOrderAdapter(private val context: Context,
	...
	override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ReviewOrderViewHolder {
		...
		return ReviewOrderViewHolder(inflater, parent)
	}
	...
	class ReviewOrderViewHolder(inflater: LayoutInflater, parent: ViewGroup) :
