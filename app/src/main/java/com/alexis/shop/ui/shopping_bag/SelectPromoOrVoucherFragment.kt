...
class SelectPromoOrVoucherFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val root = inflater.inflate(R.layout.fragment_select_promo_or_voucher, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycle.apply {
            ...
            adapter = VoucherAdapter(VOUCHER_PROMO_SELECTOR_FRAGMENT, itemList, object: OnClickItem {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
                SelectPromoOrVoucherFragment().apply {
