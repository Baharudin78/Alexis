...
interface ApiService {
    ...
    @GET("mw/wishlist")
    suspend fun getWishlistBySize(
        @Query("product_size_id") sizeId : Int
    ) : WishlistGetResponse
    ...
    @GET("mw/points-history")
    suspend fun getPointHistory() : PointResponse
    ...
    suspend fun updateNoTelp(
        @Field("phonenumber") noTelp : String,
        @Field("password") password : String
    ): ProfilResponse
    ...
    @PUT("mw/account/profile/change/email")
    @FormUrlEncoded
